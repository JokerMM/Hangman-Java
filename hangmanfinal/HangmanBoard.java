...
public class HangmanBoard extends JFrame {
    ...
    manageword word = new manageword();
    ScoreManage playerScore = new ScoreManage();
    ...
    for (Component jc : jPanel4.getComponents()) {
        if ( jc instanceof JLabel ) {
            for (char charrr  = 'a' ; charrr <= 'z' ; charrr++){
                if (charrr == ((JLabel) jc).getText().charAt(0))
                        {
                           jc.setEnabled(true);
                        }
            }
    ...
    private void refresh(){
        ...
        wordtoguess.setText(word.toString());
        PlayerName.setText(player_name);
        topscores.setText(topscr.printtopscores());
        Message.setText("Attempts left :   " + (word.GuessNumber-1) + "");
        if(word.checkwordfinish())
        {
            JOptionPane.showMessageDialog(null,
                "<html>You guessed the word<br> your score is " + playerScore.toString(),
                "YOU WON", 
        ...
        hangman_photo_changer();
    }
    
    private void hangman_photo_changer(){
        
        String imagePath = "src/images/h" + word.GuessNumber + ".png";
        ImageIcon img ;
        img = new ImageIcon(imagePath);
        img.getImage().flush();
        if (word.GuessNumber == 1 ){

            hangmanphoto.setIcon(img);
            JOptionPane.showMessageDialog(null,
                        "<html>You Lost the Game. <br> your score is " + playerScore.toString(),
                        "YOU LOST", 
                        JOptionPane.DEFAULT_OPTION);
            word.newgame();
            playerScore.checktopscore(player_name ,playerScore.getScore());
            playerScore.resetscore();
            //must put the check top score here
    ...
    private void initComponents() {
        ...
        hangmanphoto = new javax.swing.JLabel();
        ...
        hangmanphoto.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        hangmanphoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/h6.png"))); // NOI18N
        hangmanphoto.setToolTipText("");

        jPanel1.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 153, 0)));

        wordtoguess.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        wordtoguess.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        wordtoguess.setText("jLabel5");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Word to guess :");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(wordtoguess, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(wordtoguess, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(60, 60, 60))
        );
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(PlayerScore, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        Message.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 204, 0)));
        ...
        jMenuItem2.setText("Change Player Name");
        ...
        jMenuItem5.setText("Hangman");
        jMenu2.add(jMenuItem5);

        jMenuItem6.setText("Application");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(hangmanphoto, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        String result = JOptionPane.showInputDialog(null, "Enter printer name:");

        if ((result != null) && (result.length() > 0)) this.player_name = result;
        refresh(); 
    ...
    private void labelClick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelClick
        
        JLabel label = (JLabel)evt.getSource();
        char test = label.getText().charAt(0);
        if(label.isEnabled())
        {
            label.setEnabled(false);
            //word.checkletter(test);
            if(word.checkletter(test)) playerScore.addpoint();
            refresh();
        }
        System.out.println(test);

    }//GEN-LAST:event_labelClick
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HangmanBoard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new HangmanBoard().setVisible(true);
        });
    }
    ...
    private javax.swing.JLabel hangmanphoto;
